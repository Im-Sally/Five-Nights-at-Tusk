        ...
        if (type === 'night2') {
            ...
            tutorialContent.innerHTML = `
                ...
                <p>
                    ...
                    TRUMP CAN BE LURED WITH THE AUDIOS BUT YOUR MAIN PRIORITY WITH THE AUDIO LURES SHOULD BE TUSK.
                </p>
            ...
            // Night 1 教程：EP
            tutorialContent.innerHTML = `
                <h2>DEFEND YOURSELF AGAINST TUSK</h2>
                <p>
                    TUSK ALWAYS STARTS AT CAM 11. USE THE CAMERA'S AUDIO LURE TO KEEP TUSK FAR AWAY FROM YOU. 
                    MAKE SURE THE CAMERA YOU'RE PLAYING THE SOUND IN IS NEXT TO THE CAMERA WHERE TUSK IS. 
                    ...
                    TUSK DOES NOT ATTACK THROUGH THE VENTS SO DON'T BOTHER CLOSING THEM FOR THIS NIGHT.
                </p>
                <button id="tutorial-got-it">GOT IT</button>
            `;
            // 重新绑定按钮事件
